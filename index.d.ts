...
declare class TestrailApiClient {
    ...
    addResults<T extends t.INewTestResult, U extends t.ITestResult>(run_id: number, data: t.INewTestResults<T>, callback?: t.Callback<U[]>): t.PromiseResponse<U[]>;
    addResultsForCases<T extends t.INewTestResult, U extends t.ITestResult>(run_id: number, data: t.INewTestResults<T>, callback?: t.Callback<U[]>): t.PromiseResponse<U[]>;
