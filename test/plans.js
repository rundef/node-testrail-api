...
describe('plans api', function() {
  ...
  it('Get one', function (done) {
    testrail.getPlan(1, function (err, plan) {
  ...
  it('Get all', function (done) {
    testrail.getPlans(1, function (err, plans) {
      expect(err).to.be.null;
  ...
  it('Get all - filtered', function (done) {
    testrail.getPlans(1, { is_completed: 0 }, function (err, plans) {
      expect(err).to.be.null;
      expect(plans).to.be.an.array;
      done();
    });
  ...
  it('Add plan entry', function (done) {
    testrail.addPlanEntry(1, { "name": "Browsers" }, function (err, plan_entry) {
      expect(err).to.be.null;
      expect(plan_entry).to.be.an.object;
      done();
    });
  });
  ...
  it('Add plan', function (done) {
    testrail.addPlan(1, { "name": "Chrome" }, function (err, plan) {
      expect(err).to.be.null;
      expect(plan).to.be.an.object;
      done();
    });
  ...
  it('Update plan entry', function (done) {
    testrail.updatePlanEntry(1, 2, { "name": "Browsers" }, function (err, plan_entry) {
      expect(err).to.be.null;
      expect(plan_entry).to.be.an.object;
      done();
    });
  ...
  it('Update plan', function (done) {
    testrail.updatePlan(1, { "name": "Chrome" }, function (err, plan) {
      expect(err).to.be.null;
      expect(plan).to.be.an.object;
      done();
    });
  ...
  it('Close plan', function (done) {
    testrail.closePlan(1, function (err, plan) {
      expect(err).to.be.null;
      expect(plan).to.be.an.object;
      done();
    });
  ...
  it('Delete plan entry', function (done) {
    testrail.deletePlanEntry(1, 2, function (err, plan_entry) {
      expect(err).to.be.null;
      expect(plan_entry).to.be.an.object;
      done();
    });
  ...
  it('Delete plan', function (done) {
    testrail.deletePlan(1, function (err, plan) {
      expect(err).to.be.null;
      expect(plan).to.be.an.object;
      done();
    });
