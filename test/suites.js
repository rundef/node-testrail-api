...
describe('suites api', function() {
  ...
  it('Get one', function (done) {
    testrail.getSuite(1, function (err, suite) {
  ...
  it('Get all', function (done) {
    testrail.getSuites(1, function (err, suites) {
      expect(err).to.be.null;
  ...
  it('Add - success', function (done) {
    testrail.addSuite(1, { "name": "This is a new test suite" }, function (err, suite) {
      expect(err).to.be.null;
      expect(suite).to.be.an.object;
      done();
    });
  ...
  it('Add - error', function (done) {
    testrail.addSuite(2, { "name": "This is a new test suite" }, function (err, suite) {
      expect(err).to.not.be.null;
      expect(suite).to.be.undefined;
      done();
    });
  });
  ...
  it('Update', function (done) {
    testrail.updateSuite(1, { "name": "This is a new test suite" }, function (err, suite) {
      expect(err).to.be.null;
      expect(suite).to.be.an.object;
      done();
    });
  ...
  it('Delete', function (done) {
    testrail.deleteSuite(1, function (err, suite) {
      expect(err).to.be.null;
      expect(suite).to.be.an.object;
      done();
    });
