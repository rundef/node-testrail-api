...
describe('tests api', function() {
  ...
  it('Get one', function (done) {
    testrail.getTest(1, function (err, test) {
  ...
  it('Get one - not found', function (done) {
    testrail.getTest(2, function (err, test) {
  ...
  it('Get all', function (done) {
    testrail.getTests(1, function (err, tests) {
      expect(err).to.be.null;
  ...
  it('Get all - filtered', function (done) {
    testrail.getTests(1, { status_id: '4,5' }, function (err, tests) {
      expect(err).to.be.null;
      expect(tests).to.be.an.array;
      done();
    });
