...
describe('configs api', function() {
  ...
  it('Get all', function (done) {
    testrail.getConfigs(1, function (err, configs) {
  ...
  it('Add config group', function (done) {
    testrail.addConfigGroup(1, { "name": "Browsers" }, function (err, config_group) {
      expect(err).to.be.null;
      expect(config_group).to.be.an.object;
      done();
    });
  });
  ...
  it('Add config', function (done) {
    testrail.addConfig(1, { "name": "Chrome" }, function (err, config) {
      expect(err).to.be.null;
  ...
  it('Update config group', function (done) {
    testrail.updateConfigGroup(1, { "name": "Browsers" }, function (err, config_group) {
      expect(err).to.be.null;
      expect(config_group).to.be.an.object;
      done();
    });
  ...
  it('Update config', function (done) {
    testrail.updateConfig(1, { "name": "Chrome" }, function (err, config) {
      expect(err).to.be.null;
      expect(config).to.be.an.object;
      done();
    });
  ...
  it('Delete config group', function (done) {
    testrail.deleteConfigGroup(1, function (err, config_group) {
      expect(err).to.be.null;
      expect(config_group).to.be.an.object;
      done();
    });
  ...
  it('Delete config', function (done) {
    testrail.deleteConfig(1, function (err, config) {
      expect(err).to.be.null;
      expect(config).to.be.an.object;
      done();
    });
