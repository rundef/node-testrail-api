...
describe('plans api', function() {
  ...
  it('Get all', function (done) {
    testrail.getResults(1, function (err, results) {
  ...
  it('Get all - filtered', function (done) {
    testrail.getResults(1, { status_id: 2 }, function (err, results) {
      expect(err).to.be.null;
      expect(results).to.be.an.array;
      done();
    });
  ...
  it('Get all for case', function (done) {
    testrail.getResultsForCase(1, 2, function (err, results) {
      expect(err).to.be.null;
      expect(results).to.be.an.array;
      done();
    });
  ...
  it('Get all for case - filtered', function (done) {
    testrail.getResultsForCase(1, 2, { status_id: 3 }, function (err, results) {
      expect(err).to.be.null;
      expect(results).to.be.an.array;
      done();
    });
  ...
  it('Get all for run', function (done) {
    testrail.getResultsForRun(1, function (err, results) {
      expect(err).to.be.null;
      expect(results).to.be.an.array;
      done();
    });
  ...
  it('Get all for run - filtered', function (done) {
    testrail.getResultsForRun(1, { status_id: 2 }, function (err, results) {
      expect(err).to.be.null;
      expect(results).to.be.an.array;
      done();
    });
  ...
  it('Add one', function (done) {
    testrail.addResult(1, { "comment": "This test failed" }, function (err, result) {
      expect(err).to.be.null;
  ...
  it('Add one for case', function (done) {
    testrail.addResultForCase(1, 2, { "comment": "This test failed" }, function (err, result) {
      expect(err).to.be.null;
      expect(result).to.be.an.object;
      done();
    });
  ...
  it('Add multiple', function (done) {
    testrail.addResults(1, [{ "comment": "This test failed" }], function (err, results) {
      expect(err).to.be.null;
      expect(results).to.be.an.array;
      done();
    });
  ...
  it('Add multiple for case', function (done) {
    testrail.addResultsForCases(1, [{ "comment": "This test failed" }], function (err, results) {
      expect(err).to.be.null;
      expect(results).to.be.an.array;
      done();
    });
